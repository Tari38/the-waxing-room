    ...
    <div className="homepage-container"> 
      ...
      <Row className="row" col="2">
        <Col className="home-col">
            ...
            <Button className="card-btn" href="/components/pages/services" style={{ backgroundImage: `url(${brushedMetal})` }}>View Services</Button>
        ...
        <Col className="home-col">
            ...
            <Button className="card-btn" href="/components/pages/contact" style={{ backgroundImage: `url(${brushedMetal})` }}>Contact Us</Button>
        ...
        <Col className="home-col">
            ...
            <Button className="card-btn" href="/components/pages/about" style={{ backgroundImage: `url(${brushedMetal})` }}>Find Out More</Button>
        
        </Col>
        <Col className="home-col">
            <h3>More</h3>
            <p style={{ fontFamily: `"Montserrat", sans-serif`}}>Waxing etiquette, aftercare, our shop and reviews.</p>
            <Button className="card-btn" href="/components/pages/products" style={{ backgroundImage: `url(${brushedMetal})` }}>View More</Button>
